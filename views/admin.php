...
<div class="dpe-fp-widget">
	...
	<div class="section display">
		...
		<?php if ( in_array( 'product',  $instance['posttype'] ) ) { ?>
            <p class="check cf">
              <input class="dpe-fp-promotions" id="<?php echo $this->get_field_id( 'promotions' ); ?>" name="<?php echo $this->get_field_name( 'promotions' ); ?>" type="checkbox" value="1" <?php checked( '1', $instance['promotions'] ); ?>/>
              <label for="<?php echo $this->get_field_id( 'promotions' ); ?>"><?php _e( 'Show only Products in promotions?', $this->widget_text_domain ); ?></label>
            </p>
        <?php } ?>
        <p class="check cf">
        ...
        <p class="check cf">
          <input class="dpe-fp-excerpt" id="<?php echo $this->get_field_id( 'excerpt' ); ?>" name="<?php echo $this->get_field_name( 'excerpt' ); ?>" type="checkbox" value="1" <?php checked( '1', $instance['excerpt'] ); ?> />
          <label for="<?php echo $this->get_field_id( 'excerpt' ); ?>"><?php _e( 'Show Excerpt?', $this->widget_text_domain ); ?></label>
        </p>
        <p class="check cf">
          <input class="dpe-fp-display-meta" id="<?php echo $this->get_field_id( 'display_meta' ); ?>" name="<?php echo $this->get_field_name( 'display_meta' ); ?>" type="checkbox" value="1" <?php checked( '1', $instance['display_meta'] ); ?> />
          <label for="<?php echo $this->get_field_id( 'display_meta' ); ?>"><?php _e( 'Show Meta Info (Date/Category)?', $this->widget_text_domain ); ?></label>
        </p>
		<p class="cf">
        ...
        <p class="cf">
            <label for="<?php echo $this->get_field_id( 'display_mode' ); ?>"><?php _e( 'Display Mode:', $this->widget_text_domain ); ?></label>
            <select name="<?php echo $this->get_field_name( 'display_mode' ); ?>" id="<?php echo $this->get_field_id( 'display_mode' ); ?>">
                <?php
                foreach ($this->display_mode as $key => $value ) {
                    echo '<option value="' . $key . '" id="' . $this->get_field_id( $key ) . '"', $instance['display_mode'] == $key ? ' selected="selected"' : '', '>', $value , '</option>';
                }
                ?>
            </select>
        </p>
