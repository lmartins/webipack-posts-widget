 ...
 */
class WIP_Posts_Widget extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'wip_fp_widget';
     ...
     * @var      string
     */
    protected $widget_text_domain = 'webipack-posts-widget';
	...
	public function setup_defaults() {
		...
		$this->display_mode = array (
			'simple' => __( 'Simple', $this->get_widget_text_domain() ),
			'slider' => __( 'Slider', $this->get_widget_text_domain() )
		);
...
} // class WIP_Posts_Widget


/**
 * Initialize the widget on widgets_init
 */
add_action( 'widgets_init', create_function( '', 'register_widget("WIP_Posts_Widget");' ) );
